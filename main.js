...
window.addEventListener("devicemotion", function(e){ accelerator.strength = timer.fps; accelerator.handleMotionEvent(e); }, false);
...
var redraw = function(t)
{
    ...
    renderer.uiText("o: " + round(gyroscope.orientation.x, -3) + " " + Math.round(gyroscope.orientation.y, -3), new Vector2(textX, 45), fontColor);
    renderer.uiText("a: " + round(accelerator.motion.x, -3) + " " + Math.round(accelerator.motion.y, -3) + " " + Math.round(accelerator.motion.z, -3), new Vector2(textX, 55), fontColor);
